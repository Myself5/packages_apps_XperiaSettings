...
public class XperiaSettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static String OTG_SYSFS_PATH = "/sys/module/qpnp_smbcharger_extension/parameters/start_id_polling";
    /**
    ...
    private static Preference.OnPreferenceChangeListener mPreferenceListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            switch (preference.getKey()) {
                case "otg_switch":
                    sysfspath = OTG_SYSFS_PATH;
                    writestring = ((Boolean) value ? "1" : "0");
                    break;
                default:
                    break;
            }
            ...
            try {
                FileOutputStream fos = new FileOutputStream(sysfspath);
                fos.write(writestring.getBytes(Charset.forName("UTF-8")));
                fos.close();
            } catch (Exception e) {
                // fail silently
            }
